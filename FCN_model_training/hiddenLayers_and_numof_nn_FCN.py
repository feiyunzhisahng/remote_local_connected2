...
if __name__ == '__main__':
    ...
    for config1 in layer_configs_1:
        ...
        print(f'Layers config_1: {config1}, Test Accuracy: {accuracy:.2f}%;execution time: {excution_time:.2f} seconds')
    ...
    for config2 in layer_configs_2:
        ...
        print(f'Layers config_2: {config2}, Test Accuracy: {accuracy:.2f}%;execution time: {excution_time:.2f} seconds')
